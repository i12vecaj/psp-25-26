...
public class ProcesadorDeClientes implements Runnable {
    private Socket socket;

    public ProcesadorDeClientes(Socket socketCliente) {
    ...
    public void run() {
        try (
            ...
            salida.println("¡Hola! Bienvenido al servidor multicliente");
