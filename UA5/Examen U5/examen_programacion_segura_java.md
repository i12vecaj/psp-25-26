...
//Nunca se cifra los datos introducidos por el usuario.       
        
//conexion directa a base de datos. Vulnerabilidad y acceso directo al mismo

        Connection con = DriverManager.getConnection(
                "jdbc:mysql://localhost/app", "root", "root");

        Statement st = con.createStatement();
//Consultas creadas directamente en codigo.
        String query = "SELECT * FROM usuarios WHERE nombre='"
                + user + "' AND password='" + pass + "'";

        ResultSet rs = st.executeQuery(query);

//Comparacion segun la consulta, con los datos directos introducidos por el usuario.
        if(rs.next()) {
...
//Es cuando se procede a hacer algun tipo de manipulacion SQL con informacion recibida directamente,
totalmente en codigo, haciendo que cualquier persona capaz de abrir el codigo pueda manipularlo.
Se suele prevenir cifrando la informacion recibida del usuario en cuestion, y trabajando en otras lineas de codigo con los datos cifrados,
de manera que no pueda interceder directamente con la base de datos desde el codigo
...
//Porque cualquier persona puede manipular o acceder al programa editando el texto plano.
¿Qué técnica se debe usar en su lugar?
//Sistemas de cifrado como Hash.
...
//Es como un codigo DNI que autoriza el acceso y uso de los distintos servicios a los cuales tenga acceso, impidiendo que una persona pueda usar distintos servicios o servicios completos si no lo tiene autorizado en su certificado. 
