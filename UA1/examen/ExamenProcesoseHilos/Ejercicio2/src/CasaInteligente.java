 ...
 * Descripción: Imagina que en una casa inteligente se realizan varias tareas al mismo tiempo:
...
public class CasaInteligente {
    public static void main(String[] args) {
        ...
        System.out.println("Programa comenzando: ");

        LavarRopa lavarropa = new LavarRopa(6);
        Cocinar cocinar = new Cocinar(8);
