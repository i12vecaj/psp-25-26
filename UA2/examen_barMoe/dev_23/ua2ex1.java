    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("[ESPERA] Cliente " + getName() + ": Descansando " + tiempoDormir + " ms.");
                Thread.sleep(tiempoDormir);

            } catch (InterruptedException e) {
                System.err.println("[FIN] Cliente " + getName() + ": INTERRUMPIDO. Terminando.");
                if (vaso != null) {
                    camarero.devolverCerveza(vaso, getName());
                }
...
public class ua2ex1 {
    ...
    public static void main(String[] args) {
        System.out.println("\n=========================================");
        System.out.println("=== INICIO DE LA SIMULACIÓN DE BAR ===");
        System.out.println("=========================================");
        ...
        try {
            System.out.println("\n--- Simulación en curso por 10 segundos ---");
            Thread.sleep(10000);
            ...
            System.err.println("Error en el hilo principal.");
            Thread.currentThread().interrupt();
        }
