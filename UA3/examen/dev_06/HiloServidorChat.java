...
public class HiloServidorChat extends Thread {
	...
	public void run() {
		...
		while (true) {
			...
			try {
				...
				comun.setACTUALES(comun.getACTUALES() - 1); // Reducimos el numero de conexiones actuales
				System.out.println("NUMERO DE CONEXIONES ACTUALES: " + comun.getACTUALES());
	...
	private void EnviarMensajesaTodos(String texto) { // Funcion que envia los mensajes al chat
		int i;
