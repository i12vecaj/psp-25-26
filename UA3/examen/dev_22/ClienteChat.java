...
public class ClienteChat implements Runnable {
    ...
    public void run() {
        ...
        while (repetir) {
            try {
                //Lee desde el servidor el mensaje enviado
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            // Crea el cliente que se conecta al servidor y prepara el flujo de entrada y salida
        ...
        while(repetir)
        {
            //Lee lo que el usuario esta poniendo
