...
public class ServidorChat
{
	...
	public static void main(String args[]) throws IOException {
		int PUERTO = 44444; // puerto de escucha

		ServerSocket servidor = new ServerSocket(PUERTO);
		System.out.println("Servidor iniciado...");

		Socket tabla[] = new Socket[MAXIMO]; //para controlar las conexiones
		ComunHilos comun = new ComunHilos(MAXIMO, 0, 0, tabla); //objeto comun a todos los hilos
		...
		while (comun.getCONEXIONES() < MAXIMO) {
			...
			hilo.start(); // arrancamos el hilo, mejor que run()
		}
		servidor.close();
	}//main
}//ServidorChat..
