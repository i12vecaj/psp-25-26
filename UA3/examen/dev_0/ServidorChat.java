...
public class ServidorChat {
	...
	public static void main(String args[]) throws IOException {
		int PUERTO = 44444; // Ponemos el mismo puerto que en el cliente para que se puedan
							// conectar(Alejandro Cordoba)
		...
		while (comun.getCONEXIONES() < MAXIMO) {
			...
			hilo.start(); // arrancamos el hilo para atender al cliente
		}
		servidor.close();
	}// main
}// ServidorChat..
