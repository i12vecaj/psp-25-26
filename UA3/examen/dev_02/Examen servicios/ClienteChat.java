...
public class ClienteChat implements Runnable {
	...
	String nombre;
	Scanner scan = new Scanner(System.in); // Creo un Scanner para recoger datos
	...
	public void run() {
		...
		while (repetir) {
			try {
				texto = scan.nextLine(); ///Para escribir el mensaje
	...
	public static void main(String args[]) throws IOException {
		...
		try {
			...
			cliente = new ClienteChat(s, nombre);		// Consigue los datos de cliente
