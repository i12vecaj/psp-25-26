...
public class ServidorChat
{
    ...
    public static void main(String args[]) throws IOException {
        int PUERTO = 44444; // Ponemos un puerto

        ServerSocket servidor = new ServerSocket(PUERTO);
        System.out.println("Servidor iniciado...");

        Socket tabla[] = new Socket[MAXIMO]; //para controlar las conexiones
        ComunHilos comun = new ComunHilos(MAXIMO, 0, 0, tabla); //Creamos una instancia de la clase ComunHilos
        ...
        while (comun.getCONEXIONES() < MAXIMO) {
            ...
            hilo.start(); //Llamamos a la función start() para empezar a funcionar el programa
        }
        servidor.close();
    }//main
}//ServidorChat..
