...
public class HiloServidorChat extends Thread {
    ...
    public HiloServidorChat(Socket s, ComunHilos comun) {
        ...
        try {
            ...
            fentrada = new DataInputStream(socket.getInputStream()); // Llamamos a socket y utilizamos su función para obtener los datos
        } catch (IOException e) {
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                comun.setACTUALES(comun.getACTUALES()); // Usamos el get para saber cuantos clientes hay conectados
                System.out.println("NUMERO DE CONEXIONES ACTUALES: " + comun.getACTUALES());
    ...
    private void EnviarMensajesaTodos(String texto) { // Le definimos el tipo de dato que queremos que entre
        int i;
