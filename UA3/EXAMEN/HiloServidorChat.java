...
public class HiloServidorChat extends Thread {
    ...
    public HiloServidorChat(Socket s, ComunHilos comun) {
        ...
        try {
            ...
            fentrada = new DataInputStream(socket.getInputStream()); // flujo de entrada con el cliente y socket
        } catch (IOException e) {
        ...
        while (true) {
            ...
            try {
                ...
                if (cadena.trim().equals("*")) {// EL CLIENTE SE DESCONECTA
                    comun.setACTUALES(comun.getACTUALES() - 1); // disminucion de conexiones actuales
                    System.out.println("NUMERO DE CONEXIONES ACTUALES: " + comun.getACTUALES());
                }
    ...
    private void EnviarMensajesaTodos(String texto) { // formato texto por eso es String parametro 
        int i;
